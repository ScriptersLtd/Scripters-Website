...
const PortfolioHeading = () => {
  ...
  return (
    <div
      className=" sm:h-[200rem] sm:w-[100vw] overflow-hidden relative flex flex-col  panel bg-neutral-900  sm:bg-transparent pt-12 sm:pt-44 sm:pt-0"
      ref={refPortfolioHeading}
      
    >
      <motion.h2
        className={`z-10 text-[45px] md:text-[70px] lg:text-[100px] whitespace-nowrap text-center sticky top-[10rem] text-neutral-100 sm:text-neutral-900 font-bold select-none pb-12 sm:pb-0`}
        style={{
          scale: isSmallScreen
            ? ""
            : isMediumScreen
