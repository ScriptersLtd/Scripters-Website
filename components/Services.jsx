...
const Services = () => {
  ...
  const smallx2 = useTransform(scrollYProgress, [0.55, 0.7, 0.76, 0.9], ["10%","0%","0%", "-15%"]);
  ...
  return (
    <div
      className="flex flex-col items-center justify-center panel py-36 h-[260vh]"
      data-color="white"
      ref={ref}
    >
      ...
      <div className=" flex flex-col xl:flex-row w-full items-center justify-between px-4 mx-2 pb-6 mb-6 xl:px-28 xl:mx-6 xl:pb-20 xl:mb-20  border-neutral-900 border-b-2">
        <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold pb-2">Website Design</h3>
        <motion.img
      ...
      <div className=" flex flex-col xl:flex-row w-full items-center justify-between px-4 mx-2 pb-6 mb-6 xl:px-28 xl:mx-6 xl:pb-20 xl:mb-20 border-neutral-900 border-b-2">
        <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold pb-2">Website Development</h3>
        <motion.img
      ...
      <div className=" flex flex-col xl:flex-row w-full items-center justify-between px-4 mx-2 pb-6 mb-6 xl:px-28 xl:mx-6 xl:pb-20 xl:mb-20 border-neutral-900 border-b-2">
        <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold pb-2">Digital Marketing</h3>
        <motion.img
